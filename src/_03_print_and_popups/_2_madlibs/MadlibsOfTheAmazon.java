...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjetive = JOptionPane.showInputDialog("Can you tell me an adjetive");
		// Get the player to enter a type of liquid
String liquid = JOptionPane.showInputDialog("What do you drink?");
...
String enterPlace = JOptionPane.showInputDialog("What is a place");
		...
		"back to the ["+enterPlace+"]. Good luck!";
